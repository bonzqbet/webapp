...
<body>
    ...
    <header>
        <div class="overlay">
            <h1>ลงทะเบียน</h1>
            ชื่อ : <input type="text" name="Fname" required> นามสกุล : <input type="text" name="Lname" required><br>
            เพศ : ชาย<input type="radio" name="gender" value="ชาย">หญิง<input type="radio" name="gender" value="หญิง"><br>
            จบจากสถานศึกษา : <input type="text" name="school"required><br>
            GPX : <input type="text" name="GPX"required><br>
            เบอร์โทรศัพท์ : <input type="text" name="tel"pattern="[0-9]{10,15}" title="กรอกเบอร์โทรไม่ถูกต้อง" required><br>
